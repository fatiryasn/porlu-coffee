...
export default function Home() {
  return (
    <>
      ...
      {/* sect 6 (address) */}
      <section className="pb-20 mt-48 px-5 md:px-10 lg:px-40" id="location">
      ...
      <section className="flex flex-col items-center lg:items-start lg:flex-row justify-evenly py-24 mt-20 px-3 md:px-12 lg:px-24 xl:px-40 bg-gradient-to-b to-green-800 via-green-200 from-gray-50/50 lg:gap-5">
        <div className="text-center flex flex-col items-center gap-3 lg:mt-32">
          ...
          >
            <button className="flex items-center gap-1 border-2 border-white px-8 py-2 mt-5 rounded-3xl md:text-xl font-jura font-semibold text-white bg-green-600 cursor-pointer hover:bg-green-700 transition">
